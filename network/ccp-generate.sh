...
cp organizations/peerOrganizations/org1.example.com/connection-org1.* ../api-2.0/config/
...
cp organizations/peerOrganizations/org2.example.com/connection-org2.* ../api-2.0/config/
...
cp organizations/peerOrganizations/org3.example.com/connection-org3.* ../api-2.0/config/